 ...
 <header class="navbar-container">
   <div class="navbar-wrapper">
     ...
     <div class="user-actions">
       ...
       <div v-else class="unlogged-actions">
        <button class="login-btn" @click="showLoginModal = true">登录</button>
        
        <!-- 调试按钮及菜单 -->
        <div class="debug-container">
          <button class="login-btn debug-btn" @click="goToUserProfile">调试</button>
          <div class="debug-menu">
            <div class="debug-menu-item">test</div>
          </div>
        </div>
      </div>
     </div>
...
.debug-container:hover .debug-menu {
  display: block;
}
